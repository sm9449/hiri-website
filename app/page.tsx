...
export default function HomePage() {
  return <div className="page home-page">
    <section className="hero"><Container><div className="hero-grid"><div className="hero-copy">
      ...
      <p className="hero-lead">Learn Creative English with published author and educator <strong>Shaanzae Shahid</strong>, through a four-week course combining expert teaching, structured writing practice, personalised feedback and an intelligent Coach and Mentor that guide each student through the journey.</p>
